...
def choose_action():
    ...
    if action == "1":
        ...
        print(f"Daño actual: {player_damage}")
        choose_action()
    elif action == "5":
...
def spawn_enemy(enemy_type):
    ...
    while enemy_life > 0:
        personaje_fuerza = player_damage
    ...
    for obj in objects:
        print(f"""
            nombre: {obj.nombre}
              ...
              daño: {obj.daño}
""")
    eleccion = input("que quieres elegir? pon la id: ")

    if eleccion == "0":
        print("compraste un nuevo item")
        daño_del_jugador(40)
        Shop()
        abrirInventario.agregar_item("guadaña")
        
    elif eleccion == "1":
        print("compraste un nuevo item")
        daño_del_jugador(10)
        Shop()
        abrirInventario.agregar_item("espada normal")
        
    elif eleccion == "2":
        print("compraste un nuevo item")
        daño_del_jugador(20)
        Shop()
        abrirInventario.agregar_item("hacha")
